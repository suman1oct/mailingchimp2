"""
Django settings for mailingchimp2 project.
...
SECRET_KEY = 'ooodk7b!o_$zdob*-+c193kfftxj%c(j3x(%6j^#-jm(stghg_'
...
ROOT_URLCONF = 'mailingchimp2.urls'
...
WSGI_APPLICATION = 'mailingchimp2.wsgi.application'
